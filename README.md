...
> You can create a file called terraform.tfvars or copy [variables.tf](https://github.com/rohit-tambakhe/CircleCI-Terraform-EKS/blob/master/variables.tf) into the project root, if you would like to over-ride the defaults.
...
```terraform
module "eks" {
  source  = "rohit-tambakhe/CircleCI-Terraform-EKS/eks/aws"
